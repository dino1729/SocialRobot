...
def main(
    ...
    Args:
        ...
        device: Device for faster-whisper ('cpu' or 'cuda'). If None, auto-detects.
    ...
    # Determine device: use provided value or auto-detect
    if device is None:
    ...
    if compute_type is None:
        ...
        if compute_type not in valid_types:
            ...
            print(f"-> Using compute type: {compute_type} (device: {stt_device})")
...
Examples:
  ...
  python main.py --tts-engine kokoro --tts-voice af_sarah --tts-speed 1.2
  ...
  python main.py --tts-engine piper --tts-gpu --compute-type int8
        """,
    )
    ...
    parser.add_argument(
        ...
        choices=["cpu", "cuda"],
        default=None,
        help="Device for faster-whisper (cpu or cuda). If not specified, auto-detects.",
    )
